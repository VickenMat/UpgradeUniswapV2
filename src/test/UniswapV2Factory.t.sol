...
contract TestUniswapV2Factory {
    ...
    function testFeeToSetter() public {
        address expectedSetter = address(this);
        require(
            factory.feeToSetter() == expectedSetter,
            "Fee setter should be contract creator"
        );
    }
    ...
    function testCreatePair() public {
        ...
        address expectedPair = factory.getPair(tokenA, tokenB);
        require(expectedPair != address(0), "Pair should be created");
        require(factory.allPairsLength() == 1, "All pairs length should be 1");
    }
